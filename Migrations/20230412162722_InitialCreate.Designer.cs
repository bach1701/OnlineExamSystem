...
namespace OnlineExamSystem.Migrations
{
    ...
    [Migration("20230412162722_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineExamSystem.DataServicesLayer.Model.School.User", b =>
                {
                    b.HasOne("OnlineExamSystem.DataServicesLayer.Model.School.Class", "OfClass")
                        .WithOne("Teacher")
                        .HasForeignKey("OnlineExamSystem.DataServicesLayer.Model.School.User", "ClassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("OfClass");
                });
